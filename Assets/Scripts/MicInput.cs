...
// https://forum.unity.com/threads/check-current-microphone-input-volume.133501/#post-3452470
public class MicInput : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Text textObject = label.GetComponent<UnityEngine.UI.Text>();
        textObject.text = MicLoudnessinDecibels.ToString("R");
    }
